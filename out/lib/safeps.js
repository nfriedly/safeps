...
(function() {
  ...
  isWindows = ((ref = process.platform) != null ? ref.indexOf('win') : void 0) === 0;
  ...
  safeps = {
    ...
    initOrPullGitRepo: function(opts, next) {
      ...
      safefs.ensurePath(opts.cwd, function(err, exists) {
        ...
        if (exists) {
          ...
          return safeps.spawnMultiple(commands, opts, function() {
            var err, result;
    ...
    initNodeModules: function(opts, next) {
      var err, nodeModulesPath, packageJsonPath, partTwo, pathUtil, ref2;
      pathUtil = require('path');
      ref2 = extractOptsAndCallback(opts, next), opts = ref2[0], next = ref2[1];
      if (opts.path) {
      ...
      partTwo = function() {
        return safefs.exists(packageJsonPath, function(exists) {
          ...
          return safeps.spawn(command, opts, next);
        });
      };
      if (opts.force === false) {
